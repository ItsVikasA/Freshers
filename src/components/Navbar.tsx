        ...
        <div className="container mx-auto px-6 py-3.5">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1">
              <span className="text-2xl font-bold font-orbitron tracking-wide bg-gradient-to-r from-cyan-400 via-blue-500 to-indigo-500 bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(34,211,238,1)] animate-pulse">Navasparsha</span>
        ...
        <div className="px-4 py-3.5">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-0.5">
              <span className="text-sm font-bold font-orbitron tracking-wide bg-gradient-to-r from-cyan-400 via-blue-500 to-indigo-500 bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(34,211,238,1)]">Navasparsha</span>
