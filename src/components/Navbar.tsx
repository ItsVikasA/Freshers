        ...
        <div className="container mx-auto px-6 py-3.5">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1">
              <span className="text-2xl font-bold font-orbitron tracking-wide bg-gradient-to-r from-pink-500 to-pink-400 bg-clip-text text-transparent drop-shadow-[0_0_15px_rgba(236,72,153,0.8)]">Navasparsha</span>
              <span className="text-2xl font-bold font-orbitron tracking-wide bg-gradient-to-r from-pink-400 to-orange-400 bg-clip-text text-transparent">-</span>
              <span className="text-2xl font-bold font-orbitron tracking-wide bg-gradient-to-r from-orange-400 to-orange-500 bg-clip-text text-transparent drop-shadow-[0_0_15px_rgba(251,146,60,0.8)]">2k25</span>
            </div>
        ...
        <div className="px-4 py-3.5">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-0.5">
              <span className="text-sm font-bold font-orbitron tracking-wide bg-gradient-to-r from-pink-500 to-pink-400 bg-clip-text text-transparent drop-shadow-[0_0_15px_rgba(236,72,153,0.8)]">Navasparsha</span>
              <span className="text-sm font-bold font-orbitron tracking-wide bg-gradient-to-r from-pink-400 to-orange-400 bg-clip-text text-transparent">-</span>
              <span className="text-sm font-bold font-orbitron tracking-wide bg-gradient-to-r from-orange-400 to-orange-500 bg-clip-text text-transparent drop-shadow-[0_0_15px_rgba(251,146,60,0.8)]">2k25</span>
            </div>
